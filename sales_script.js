    ...
    "call_one": [
      {
        ...
        "script": "Hey [FirstName], <i>great to meet you</i>.<br><br>I'm looking forward to spending the next <u>30 minutes</u> with you here, and happy to get right into it if that's all right with you?<br><br>(Pause for confirmation)<br><br><i>Perfect</i>. Before we get into specifics, I want to treat this like <u>mutual due diligence</u> - so I can understand what you're working on, what's driving the conversation, and whether an engagement <b>even makes sense to prescribe</b>.<br><br>My goal today is to understand how your business functions - specifically how you're <b>generating interest</b> in the market, what markets that demand comes from, and how it gets processed into <b>conversion events</b>.<br><br>Everything we do is built around <b>anchors and risk mitigation</b>, so I'll walk you through that as we go.<br><br><b>Walk me through</b> what you're focused on right now. Tell me about the business, how you're currently generating demand, and which markets that demand is coming from.",
        "advisor_notes": [
          ...
          "The phrase 'mutual due diligence' + 'makes sense to prescribe' establishes evaluator position immediately",
          "'Walk me through' is a command, not a request - this sets advisory authority"
        ]
      },
      {
        "id": "fork_deflection",
      ...
      },
      {
        ...
        "optional_approval_flow_questions": "These questions help you gain ground in the buying process without sounding pushy. Ask 1-2 during or after this section. See reference library: 'Approval Flow & Buying Process Questions'",
        "advisor_notes": [
