    ...
    "call_one": [
        ...
        "paths": [
          {
            ...
            "proof_narrative": {
              ...
              "six_beats": {
                "beat_1_engagement_context": "They came to us needing to open more relationships with schools and districts—principals, administrators, parent committees.<br><br>Now, here's why this is a perfect fit for our thesis: education is specialized, brand-sensitive, and the data is expensive to acquire. Most agencies would fail there. We thrive there.",
                "beat_2_diligence_extraction": "We spent time with their team—field reps, regional managers, leadership—to understand one thing: <u>how do schools actually decide, and what language matters in that world?</u><br><br>That's the diligence process. It's what lets us identify qualified buyers without guessing. It's also what protects you from wasting time on tire kickers.<br><br>And here's the thing: they had <b>decades of that knowledge in their heads</b>. Our diligence extracted it and turned it into a targeting map.",
                "beat_3_brand_integrity_constraint": "In education, the brand standard is <b>unforgiving</b>. One message that feels too pushy, and <u>you're done</u>. Years of credibility, gone.<br><br>So we set one rule: <b>generate interest without touching the third rail</b>.<br><br>That meant every piece of messaging—tone, pacing, positioning—had to sound like it came from someone inside their world, not from a marketing department.<br><br>We didn't compromise on that. Not once.",
                "beat_4_audience_presence_findings": "As part of the diligence, we mapped where these buyers actually spend time.<br><br>Over 50% on LinkedIn. The rest? Email, professional networks. So the audience was there, digital-first, even in a traditional market.<br><br><b>Most strategies miss it because they're guessing</b>. They don't do the diligence. We did.",
                "beat_5_private_infrastructure": "So we deployed the outreach through our internal infrastructure.<br><br>Think of it like <b>mission control</b>—every message, every contact list, every follow-up sequence runs through quality gates. We're checking tone, compliance, brand alignment. Nothing goes out that doesn't reflect their world.<br><br>And because it's all orchestrated centrally, we can scale it—from one region to fifty states to international—all while maintaining the same brand voice.<br><br>That's what '<u>private infrastructure</u>' means. Not tools. Orchestration.",
                "beat_6_hardest_first_proof_tieback": "Here's what happened: <b>373 qualified conversations in 90 days</b>.<br><br>Their sales cycle is short—about 30 days—so they closed business quickly. <u>Over $1M in new revenue</u> in that first quarter, all without touching their brand reputation.<br><br>And here's why I'm telling you this: if we can do that in education—where brand risk is the highest I've seen—then what we're doing in your market is essentially the same playbook. <b>Different industry, same thesis</b>."
              },
            ...
            "pivot": "So that's the framework. Now here's what I want to confirm: based on what you told me about <u>[reference specific thing from their discovery]</u>, does this approach map to your world? And if it does, here's what the next conversation looks like."
          },
          {
            "id": "old_economy",
      ...
      },
      {
        ...
        "advisor_notes": [
          ...
          "Anchor timeline first: '48 to 72 hours' — don't ask theirs, state your process",
          "Force question resolution BEFORE scheduling — prevents unresolved objections from festering",
          "Use binary choice scheduling: '[Day/Time A] or [Day/Time B]?' — increases conversion vs open-ended",
